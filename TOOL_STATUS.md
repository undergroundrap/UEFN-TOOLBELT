...
UEFN Toolbelt contains **343 tools across 35+ modules**. Because many tools actively modify the viewport, spawn actors, or depend on specific Content Browser selections, **the `integration_test.py` suite uses temporary fixtures to automate verification of context-dependent tools.**
...
## 🟡 Automated Verification Status: **186 / 343 Tools (54% Coverage)**
...
**Current Integration Coverage (343 tools — 115 sections written, 103 live-verified):**
...
- All 343 tools register into the registry with valid metadata
