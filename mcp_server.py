...
After that, Claude Code has full control over UEFN — 291 tools, live actor data,
...
def run_toolbelt_tool(tool_name: str, kwargs: dict | None = None) -> str:
    ...
    This is the single most powerful MCP tool — it exposes all 291 toolbelt tools
