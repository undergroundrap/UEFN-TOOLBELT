...
- **Project-Specific Schema**: `docs/api_level_classes_schema.json` (The Brain). Generated by running `tb.run("api_crawl_level_classes")`. This file is git-ignored and contains your unique level context.
...
- **Update**: Run the crawler whenever you add new Verse devices to sync the AI's understanding.
