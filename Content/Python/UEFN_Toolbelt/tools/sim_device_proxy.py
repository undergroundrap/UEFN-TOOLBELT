...
def _resolve_verse_class(actor: unreal.Actor) -> str:
    ...
    if name == "VerseDevice_C" or "VerseDevice" in name:
        ...
        return normalized.split("_C_")[0].split("_UAID_")[0]
...
def run_generate_proxy(**kwargs) -> dict:
    ...
    lines = [
        "# Auto-generated by UEFN Toolbelt — sim_generate_proxy",
        f"# Verse class : {v_cls}",
        ...
        "    Wraps an unreal.Actor so editor tools can read and write its",
        "    properties using typed Python instead of raw string APIs.",
        '    """',
        "",
        "    def __init__(self, actor: unreal.Actor) -> None:",
        "        self._actor = actor",
    ...
    if props:
        ...
        for prop_name, meta in props.items():
            ...
            _prop_type = meta.get("type", "Any") if isinstance(meta, dict) else "Any"
    ...
    if events:
        ...
        for event in events:
            ...
            lines += [
                ...
                "        if evt and hasattr(evt, 'Subscribe'):",
